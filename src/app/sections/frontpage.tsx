...
//         <h1 className="text-8xl font-bold text-[#17414F] mb-6">
//           Essential Vitamins
//         </h1>
//       </div>

      
//     {/* Main Content and Features in a Row */}
//      {/* Main Content and Features in a Row */}
// <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-start gap-12">
//   {/* Left Content */}
//   <div className="text-center lg:text-left lg:w-1/3 flex flex-col justify-start">
//     <p className="text-xl text-[#17414F] font-semibold">
//       Online Medical Supplies
//     </p>
//     <h2 className="text-3xl font-bold text-[#17414F] my-4">
//       Get Your Vitamins & Minerals
//     </h2>
//     <button className="px-6 py-3 bg-[#17414F] text-white rounded-md hover:bg-[#14565F]">
//       Explore
//     </button>
//   </div>

//   {/* Middle Section - Hero Image */}
//   <div className="relative w-full lg:w-1/3 flex justify-center items-start">
//     {/* Background Square with Curved Corners */}
//     <div className="absolute top-0 left-0 w-64 h-64 bg-[#FADFB8] rounded-tl-[25%] rounded-br-[25%]">
//       {/* Hero Image */}
//       <Image
//         src={Heroimage}
...
//         {/* Main Content and Features in a Row */}
//       <div className="max-w-screen-xl mx-auto px-4 flex flex-col lg:flex-row items-start gap-12 my-auto">
//       {/* Left Content */}
//       <div className="text-center lg:text-left lg:w-1/3 flex flex-col justify-start mb-8 my-auto">
//         <p className="text text-[#727272] font-semibold">Online Medical Supplies</p>
...
//       {/* Middle Section - Hero Image */}
//       <div className="relative w-full lg:w-1/3 flex justify-center items-center mb-8 lg:mb-0">
//         {/* Background Square with Curved Corners */}
//         <div className="absolute -top-10 lg:top-0 left-0 w-64 h-64 bg-[#FADFB8] rounded-tl-[25%] rounded-br-[25%]">
//           {/* Hero Image */}
//           <Image
//             src={Heroimage}
//             alt="Probiotics bottle"
...
//       {/* Features Section */}
//       <div className="flex flex-col lg:w-1/3 justify-start gap-8 my-auto">
//         {/* Vitamins */}
//         <div className="flex items-center gap-3">
//           <Image src={VitaminIcon} alt="Vitamins" width={64} height={64} />
//           <div>
